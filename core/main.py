...
# Add the root directory to path for imports if needed, but relative imports from app work if run from root.
import sys
import os
...
def run_scanner():
    ...
    # Check if sectors exist, else generate
    ...
    def evaluate(ticker):
        try:
            ...
            if tech['rvol'] < 1.0 or tech['avwap_distance'] < 0:
                # Structural hard gates for rapid filtering
                return None
            ...
            return {
                ...
                'rc_weight': 0.0 # Placeholder, calculated later in portfolio engine
            }
